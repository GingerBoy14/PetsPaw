...
module.exports = {
  // ——— COLORS
  '@white': theme.color.white.default,
  '@black': '#000',
  '@dark': theme.color.dark.default,
  '@primary-color': theme.color.primary.default,
  '@success-color': theme.color.success.default,
  '@warning-color': theme.color.warning.default,
  '@error-color': '#eb161a',
  '@info-color': '#1d6fdc',
  ...
  '@border-color-split': 'fade(@dark, 10%)',
  ...
  '@text-color': '@dark,',
  '@text-color-secondary': 'fade(@dark, 65%)',
  ...
  '@typography-title-font-weight': theme.typography.fontWeight.medium,
  ...
  '@btn-default-bg': 'fade(@dark, 8%)', // @component-background
  ...
  '@btn-square-only-icon-size-sm': '20px',
  '@btn-square-only-icon-size': '24px',
  '@btn-square-only-icon-size-lg': '24px',

  // @btn-group-border: @primary-5;

  // @btn-link-hover-bg: transparent;
  '@btn-text-hover-bg': 'fade(@dark, 8%)',
  ...
  '@input-placeholder-color': '@text-color-secondary', //'@disabled-color',
  ...
  '@avatar-font-size-base': '20px',
  '@avatar-font-size-lg': '24px',
  '@avatar-bg': theme.color.dark.t.lighten7,
  '@avatar-color': theme.color.dark.t.lighten2,
  ...
  '@badge-font-weight': theme.typography.fontWeight.medium,
